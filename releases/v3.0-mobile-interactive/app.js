...
class ImmersiveAudioEngine {
  ...
  init() {
    ...
    // Setup Audio Units
    this.setupTrackRumble();
    this.setupFanHum();
    this.setupRadioStatic();
    this.setupRain();
    this.setupWind(); // Cozy whistling wind generator
    this.setupPASpeakerStatic();

    // Start Loops
    this.startTrackClackingLoop();
...
const state = {
  ...
  trainType: 'rajdhani',
  activeRoute: getInitialRouteFromPath()
};

// High quality playlists per route
const routePlaylists = {
  hindi: {
    ...
    "track_7": { title: "DIL KEHTA HAI", ytId: "PqiddY3o3aY", color: "#e67e22" },
    "track_8": { title: "TUJHE NA DEKHU TOH CHAIN", ytId: "mmgdG4UvF3Y", color: "#34495e" },
    "track_9": { title: "CHURA KE DIL MERA", ytId: "Yqj1_V90KJo", color: "#e74c3c" },
    "track_10": { title: "PEHLI PEHLI BAAR MOHABBAT KI HAI", ytId: "cBGDDBHN22U", color: "#3498db" },
    "track_11": { title: "PAAS WOH AANE LAGE", ytId: "plB0ytzIlqI", color: "#f1c40f" },
    "track_12": { title: "RAAH MEIN UNSE MULAQAT", ytId: "dDR4oiyjUBA", color: "#2ecc71" },
    "track_13": { title: "WAADA RAHA SANAM4K", ytId: "9b0iydtDZLU", color: "#9b59b6" },
    "track_14": { title: "TO CHALUN", ytId: "eQPEtbTbzVM", color: "#1abc9c" },
    "track_15": { title: "MAIN KOI AISA GEET GAOON", ytId: "vzlXfZlH5dk", color: "#e67e22" },
    "track_16": { title: "TIP TIP BARSA PAANI", ytId: "BtlnpBb4O8E", color: "#34495e" },
    "track_17": { title: "TERI UMEED TERA INTEZAR", ytId: "xvevXfFGPFY", color: "#e74c3c" },
    "track_18": { title: "TERI CHUNARIYA DIL LE GAYI LYRICAL", ytId: "XaPnZTljQbI", color: "#3498db" },
    "track_19": { title: "BAHUT PYAAR KARTE HAI", ytId: "iupGwQqjgOk", color: "#f1c40f" },
    "track_20": { title: "JAADU TERI NAZAR SONG", ytId: "n_oP9Onj0r0", color: "#2ecc71" },
    "track_21": { title: "KITABEN BAHUT SI", ytId: "ieu6xnwJxdA", color: "#9b59b6" },
    "track_22": { title: "TUMSE MILNE KO DIL KARTA HAI", ytId: "5y_TCKNzAMI", color: "#1abc9c" },
    "track_23": { title: "MERA DIL BHI KITNA PAGAL HAI", ytId: "RVQsBlI35vw", color: "#e67e22" },
    "track_24": { title: "IS PYAR SE MERI TARAF NA DEKHO (MALE)", ytId: "L3gOr6vwSjg", color: "#34495e" },
    "track_25": { title: "CHANDANI", ytId: "UMYvW7qDcFg", color: "#e74c3c" },
    "track_26": { title: "ARE RE ARE SONG", ytId: "OEpFiDKqH7E", color: "#3498db" },
    "track_27": { title: "SAATHIYA BIN TERE DIL MANE NA", ytId: "AHdo6gJKAk8", color: "#f1c40f" },
    "track_28": { title: "JAB KOI BAAT BIGAD JAAYE (LYRICAL) 🎶", ytId: "mNSYPtzpfd4", color: "#2ecc71" },
    "track_29": { title: "HUM TO DEEWANE HUYE", ytId: "ryxeZdtfo1I", color: "#9b59b6" },
    "track_30": { title: "'PYAR KIYA TO NIBHANA' MAJOR SAAB", ytId: "h_fCN4pinqs", color: "#1abc9c" },
    "track_31": { title: "AE KASH KE HUM FULL VIDEO KABHI HAAN KABHI NAA", ytId: "Jtg2zyS_y_c", color: "#e67e22" },
    "track_32": { title: "IS KADAR PYAR HAI SONU NIGAM'S SUPER HIT HINDI ALBUM", ytId: "VcbzW874Qag", color: "#34495e" },
    "track_33": { title: "GHAR SE NIKALTE HI [FULL SONG] PAPA KEHTE HAIN", ytId: "_IcVb6hFhPs", color: "#e74c3c" },
    "track_34": { title: "HOSHWALON KO KHABAR KYA", ytId: "hZuwe72Rtcc", color: "#3498db" },
    "track_35": { title: "HUM YAAR HAIN TUMHARE LYRICAL HAAN MAINE BHI PYAAR KIYA", ytId: "nNtGRkTdU9Q", color: "#f1c40f" },
    "track_36": { title: "RAJA KO RANI SE", ytId: "3C4sUKbEKrw", color: "#2ecc71" },
    "track_37": { title: "AAWAZ DO HUMKO WITH LYRICS", ytId: "QPiBVh62VUI", color: "#9b59b6" },
    "track_38": { title: "PYAR KAR SONG", ytId: "tvxXAZo1Hlg", color: "#1abc9c" },
    "track_39": { title: "SOLDIER SOLDIER", ytId: "qwJxDcuW538", color: "#e67e22" },
    "track_40": { title: "HUMKO SIRF TUMSE PYAR HAI", ytId: "Uk6CB2o2eY0", color: "#34495e" },
    "track_41": { title: "TU HI RE (MUSIC VIDEO)", ytId: "waTwDgK2tkk", color: "#e74c3c" },
    "track_42": { title: "KEH DO EK BAAR SAJANA WITH LYRICS", ytId: "-Hmf-prCzTg", color: "#3498db" },
    "track_43": { title: "90S ROMANTIC CLASSIC", ytId: "jqA-sQVsB3U", color: "#f1c40f" },
    "track_44": { title: "CHAL PYAR KAREGI", ytId: "wjmoMhMZqWs", color: "#2ecc71" },
    "track_45": { title: "DO DIL MIL RAHE HAIN", ytId: "gmJW33derRY", color: "#9b59b6" },
    "track_46": { title: "LYRICAL", ytId: "hNGQag8NS-0", color: "#1abc9c" },
    "track_47": { title: "GAWAH HAI CHAND TARE WITH LYRICS", ytId: "5m8PFW6enuY", color: "#e67e22" },
    "track_48": { title: "TERE DAR PAR SANAM VÍDEO SONG", ytId: "05o4kCUY2Ys", color: "#34495e" },
    "track_49": { title: "AANKHON KI GUSTAKHIYAN", ytId: "2hpBJd-YcpI", color: "#e74c3c" },
    "track_50": { title: "JADOO HAI TERA", ytId: "R9snTOBEWso", color: "#3498db" },
    "track_51": { title: "NAHIN SAAMNE TU", ytId: "OzJ6m0tpVIo", color: "#f1c40f" },
    "track_52": { title: "SAATHIYA TUNE KYA KIYA FULL SONG", ytId: "BplOYQpyXZA", color: "#2ecc71" },
    "track_53": { title: "MERA CHAND MUJHE AAYA HAI NAZAR", ytId: "k0DeuDTrJBM", color: "#9b59b6" },
    "track_54": { title: "TUJHE DEKHA TO YE JANA SANAM", ytId: "7JnKVPtRqVE", color: "#1abc9c" },
    "track_55": { title: "BIN TERE SANAM", ytId: "5BMZoU66Z9k", color: "#e67e22" },
    "track_56": { title: "MERE MEHBOOB MERE SANAM", ytId: "kNaXjvKPiS0", color: "#34495e" },
    "track_57": { title: "JAB SE TUMKO DEKHA", ytId: "CLGEV7CqvBs", color: "#e74c3c" },
    "track_58": { title: "AAJA SHAAM HONE AAEE", ytId: "2xITabSUf-A", color: "#3498db" },
    "track_59": { title: "DIL SE RE FULL", ytId: "MYfaX0BH2AY", color: "#f1c40f" },
    "track_60": { title: "CHANDA RE CHANDA RE (LYRICAL)", ytId: "atKqgEQoERI", color: "#2ecc71" },
    "track_61": { title: "TU MILE DIL KHILE WITH LYRICS", ytId: "9lX8GkzdNIE", color: "#9b59b6" },
    "track_62": { title: "MERI DUNIYA HAI SONG WITH EK VILLAIN", ytId: "wI-xNuJcr0M", color: "#1abc9c" },
    "track_63": { title: "TUMHEIN APNA BANANE KI KASAM", ytId: "pqFU_ZX5qfo", color: "#e67e22" },
  },
  punjab: {
  ...
  jammu: {
  "track_1": { title: "KOTHA CHUK MUNDEYA DOGRI SONG FOLK MASHUP", ytId: "OnncA0jV4P4", color: "#e74c3c" },
      "track_2": { title: "NAAL NI JAANA", ytId: "Ww1FpMX3T-k", color: "#3498db" },
      "track_3": { title: "KISSE SHEHAR NU RAAH JANDE", ytId: "P2oGKGhDEKY", color: "#f1c40f" },
      "track_4": { title: "LAL PRANDE WALI", ytId: "oex96FuRT7M", color: "#2ecc71" },
      "track_5": { title: "MEEN SARAJ", ytId: "_ufKehpW-VA", color: "#9b59b6" },
      "track_6": { title: "IK DIL TERA", ytId: "O_BBtle6sQE", color: "#1abc9c" },
      "track_7": { title: "KOKA", ytId: "TGhQ1cME4jg", color: "#e67e22" },
      "track_8": { title: "MEHLA DI RANI 2", ytId: "lGajL0IAotI", color: "#34495e" },
      "track_9": { title: "GIDHIAN DI RANIYE NE GIDHE WICH AA", ytId: "tqHgjT6UDqU", color: "#e74c3c" },
      "track_10": { title: "DHUNDLE DHUNDLE", ytId: "69Pf808Z454", color: "#3498db" },
      "track_11": { title: "MERE FOJIYA SIPAHIA", ytId: "q31UErSCjyI", color: "#f1c40f" },
      "track_12": { title: "KANGAN", ytId: "rR7ltsE43iw", color: "#2ecc71" },
      "track_13": { title: "SARI SARI RAAT", ytId: "O4n-Cjxj6pY", color: "#9b59b6" },
      "track_14": { title: "LAGGIAN ZORA ZORI", ytId: "wFIlqqh6rmk", color: "#1abc9c" },
      "track_15": { title: "JATT SANGRUR", ytId: "87FY-r6QyOI", color: "#e67e22" },
      "track_16": { title: "AAYI JAA FOUJIYA", ytId: "5DvUevuESWs", color: "#34495e" },
      "track_17": { title: "MISHRI DI DALI (FROM \"GHUND KADH LE NI SOHREYAN DA PIND AA GAYA\")", ytId: "wv1K7FrqbkU", color: "#e74c3c" },
      "track_18": { title: "CHANN SITARE (FROM \"OYE MAKHNA\")", ytId: "xjoat5I-1FI", color: "#3498db" },
      "track_19": { title: "RESHME DA TOTA", ytId: "030ubFrXO1U", color: "#f1c40f" },
      "track_20": { title: "TAPPE", ytId: "MdmuQnT6Oqg", color: "#2ecc71" },
      "track_21": { title: "RUTBA (FROM \"KALI JOTTA\")", ytId: "H1rqALc-xJo", color: "#9b59b6" },
      "track_22": { title: "MAUJ", ytId: "o0PsdyFQ3Rw", color: "#1abc9c" },
      "track_23": { title: "CHALLA", ytId: "fsM-eXNNSSo", color: "#e67e22" },
      "track_24": { title: "NAKHREY", ytId: "OcEO5pOV-3E", color: "#34495e" },
      "track_25": { title: "GALLAN HORAN NAL MARDA MOBILE TE", ytId: "53kbP0w4g1c", color: "#e74c3c" },
      "track_26": { title: "AAYI JAA FOUJIYA", ytId: "5DvUevuESWs", color: "#e74c3c" },
      "track_27": { title: "CHAH DA CUP 2", ytId: "Hla1KhRswOk", color: "#3498db" },
      "track_28": { title: "NAKHREYA MARI", ytId: "e6aw-yRFYig", color: "#f1c40f" },
      "track_29": { title: "MISS POOJA : SORRY JANU YOUNG ARMY", ytId: "q24BRh9M4NY", color: "#2ecc71" },
      "track_30": { title: "KARLO KARLO MERA AITBAAR YARO - LYRICAL", ytId: "uXJxiPxjIrQ", color: "#9b59b6" },
      "track_31": { title: "FUTURE", ytId: "IA98A_wZaRA", color: "#1abc9c" },
      "track_32": { title: "TERE WARGA", ytId: "C1uTpwsjwqs", color: "#e67e22" },
      "track_33": { title: "CHHOTI UMARE PYAR KARE NA", ytId: "tcAOblzOsDg", color: "#34495e" },
      "track_34": { title: "TUT GAYIAN", ytId: "Fm4xJIqvSlM", color: "#e74c3c" },
      "track_35": { title: "BOLANE DI LODD NAHIN", ytId: "btBkeNh8u7E", color: "#3498db" },
      "track_36": { title: "O MEHNDI RANG LAYEE", ytId: "x0p6fZAMmfE", color: "#f1c40f" },
      "track_37": { title: "HAAL PUCHIDA", ytId: "M-oZFvuubJw", color: "#2ecc71" },
      "track_38": { title: "NOOR HI NOOR", ytId: "wZLTAGXfMcs", color: "#9b59b6" },
      "track_39": { title: "SAILI KANAK", ytId: "J65H_mRY7M4", color: "#1abc9c" },
      "track_40": { title: "NACHHATAR GILL - GAWA BAITHA II BRANDED HEERAN", ytId: "wTKblj9DnNo", color: "#e67e22" },
      "track_41": { title: "DUPATTA MERA (DOGRI SONG)", ytId: "UDLl0nF02_8", color: "#34495e" },
      "track_42": { title: "TERA DIL", ytId: "DuptO437f3U", color: "#e74c3c" },
      "track_43": { title: "FAUJI MUNDA", ytId: "yLO3TWGJ-Q8", color: "#3498db" },
      "track_44": { title: "FOUJI PARDESI HONDEY", ytId: "HKODn6UTliI", color: "#f1c40f" },
      "track_45": { title: "FAUJI PARDESI NAUKRA", ytId: "STu_3rfmCr8", color: "#2ecc71" },
      "track_46": { title: "CHHETI CHHETI AAJA MERE DHOL PARDESIYA", ytId: "egw9BX_95Bc", color: "#9b59b6" },
      "track_47": { title: "DIL DE MAREEJ", ytId: "bvFVIlCQkTg", color: "#1abc9c" },
      "track_48": { title: "BUHE TE BAARIYAN KHOOL", ytId: "htOkfkPG0Rc", color: "#e67e22" },
      "track_49": { title: "MAI NI BACHDI", ytId: "dVdcFc0EM2g", color: "#34495e" },
      "track_50": { title: "KATTU TARIHAYE NOOYE", ytId: "S2rYJNsBL0s", color: "#e74c3c" },
      "track_51": { title: "KAMLO", ytId: "evijb14tdqY", color: "#3498db" },
      "track_52": { title: "KAJRA NONSTOP 2020", ytId: "Q6zn2r5c9Ws", color: "#f1c40f" },
      "track_53": { title: "BHEDDAN TERIYAN O CHUGDIYAN FAAT NEELIMA REMIX (FEAT. PARVEEN AKHTAR JARYAL)", ytId: "63nG1VnbkHU", color: "#2ecc71" }
  },
  english: {
    "track_1": { title: "JANET JACKSON - WHAT HAVE YOU DONE FOR ME LATELY (OFFICIAL MUSIC VIDEO)", ytId: "r9uizdKZAGE", color: "#e74c3c" },
    "track_2": { title: "PATRICE RUSHEN - FORGET ME NOTS", ytId: "jtMHsNhQBvI", color: "#3498db" },
    "track_3": { title: "WHITNEY HOUSTON - I WANNA DANCE WITH SOMEBODY (WHO LOVES ME) (OFFICIAL 4K VIDEO)", ytId: "eH3giaIzONA", color: "#f1c40f" },
    "track_4": { title: "UPSIDE DOWN", ytId: "hDHW5wXBvLw", color: "#2ecc71" },
    "track_5": { title: "MICHAEL JACKSON - HUMAN NATURE", ytId: "YNzuiRuQNYY", color: "#9b59b6" },
    "track_6": { title: "PRINCE & THE REVOLUTION - PURPLE RAIN", ytId: "uW1UIDYmYyI", color: "#1abc9c" },
    "track_7": { title: "RUFUS AND CHAKA KHAN - AIN'T NOBODY [HD REMASTER]", ytId: "BNirQXe8HOA", color: "#e67e22" },
    "track_8": { title: "MICHAEL JACKSON - BILLIE JEAN", ytId: "Zi_XLOBDo_Y", color: "#34495e" },
    "track_9": { title: "WHITNEY HOUSTON - I WILL ALWAYS LOVE YOU (OFFICIAL 4K VIDEO)", ytId: "3JWTaaS7LdU", color: "#e74c3c" },
    "track_10": { title: "MICHAEL JACKSON - THE WAY YOU MAKE ME FEEL", ytId: "HzZ_urpj4As", color: "#3498db" },
    "track_11": { title: "MICHAEL JACKSON - ROCK WITH YOU (OFFICIAL VIDEO - UPSCALED)", ytId: "5X-Mrc2l1d0", color: "#f1c40f" },
    "track_12": { title: "EARTH, WIND & FIRE - LET'S GROOVE (OFFICIAL HD VIDEO)", ytId: "Lrle0x_DHBM", color: "#2ecc71" },
    "track_13": { title: "WHITNEY HOUSTON - GREATEST LOVE OF ALL (OFFICIAL 4K VIDEO)", ytId: "IYzlVDlE72w", color: "#9b59b6" },
    "track_14": { title: "ROCKWELL - SOMEBODY'S WATCHING ME (OFFICIAL MUSIC VIDEO)", ytId: "7YvAYIJSSZY", color: "#1abc9c" },
    "track_15": { title: "LIONEL RICHIE - ALL NIGHT LONG (ALL NIGHT)", ytId: "nqAvFx3NxUM", color: "#e67e22" },
    "track_16": { title: "KOOL & THE GANG - GET DOWN ON IT", ytId: "qchPLaiKocI", color: "#34495e" },
    "track_17": { title: "WHITNEY HOUSTON - HOW WILL I KNOW (OFFICIAL HD VIDEO)", ytId: "m3-hY-hlhBg", color: "#e74c3c" },
    "track_18": { title: "PRINCE AND THE REVOLUTION - KISS (OFFICIAL MUSIC VIDEO)", ytId: "H9tEvfIsDyo", color: "#3498db" },
    "track_19": { title: "MICHAEL JACKSON - P.Y.T. (PRETTY YOUNG THING)", ytId: "1ZZQuj6htF4", color: "#f1c40f" },
    "track_20": { title: "PRINCE AND THE REVOLUTION - RASPBERRY BERET (OFFICIAL 4K MUSIC VIDEO)", ytId: "l7vRSu_wsNc", color: "#2ecc71" },
    "track_21": { title: "SHE'S A BAD MAMA JAMA (SHE'S BUILT, SHE'S STACKED)", ytId: "l-MHDRuJ1ME", color: "#9b59b6" },
    "track_22": { title: "PART-TIME LOVER", ytId: "MpDM6ygsb20", color: "#1abc9c" },
    "track_23": { title: "LUTHER VANDROSS - NEVER TOO MUCH (OFFICIAL HD VIDEO)", ytId: "pNj9bXKGOiI", color: "#e67e22" },
    "track_24": { title: "I LIKE IT", ytId: "4Sn6Upf43TA", color: "#34495e" },
    "track_25": { title: "SOUL II SOUL - BACK TO LIFE (HOWEVER DO YOU WANT ME) (OFFICIAL MUSIC VIDEO) FT. CARON WHEELER", ytId: "TB54dZkzZOY", color: "#e74c3c" },
    "track_26": { title: "WHITNEY HOUSTON - SAVING ALL MY LOVE FOR YOU (OFFICIAL HD VIDEO)", ytId: "ewxmv2tyeRs", color: "#3498db" },
    "track_27": { title: "THE GAP BAND - YOU DROPPED A BOMB ON ME (OFFICIAL MUSIC VIDEO)", ytId: "17lkdqoLt44", color: "#f1c40f" },
    "track_28": { title: "DENIECE WILLIAMS - LET'S HEAR IT FOR THE BOY", ytId: "gI7YHZVc7mM", color: "#2ecc71" },
    "track_29": { title: "THE BROTHERS JOHNSON - STOMP!", ytId: "tPBDMihPRJA", color: "#9b59b6" },
    "track_30": { title: "BOBBY BROWN - MY PREROGATIVE", ytId: "5cDLZqe735k", color: "#1abc9c" },
    "track_31": { title: "THE GAP BAND - EARLY IN THE MORNING (OFFICIAL MUSIC VIDEO)", ytId: "aobIboK_z34", color: "#e67e22" },
    "track_32": { title: "CAMEO - CANDY", ytId: "sn8KYD1Vco0", color: "#34495e" },
    "track_33": { title: "CHAKA KHAN - I FEEL FOR YOU (OFFICIAL MUSIC VIDEO) [HD REMASTER]", ytId: "YW0sxgYAmLM", color: "#e74c3c" },
    "track_34": { title: "I'M COMING OUT", ytId: "AGO19YOaw6U", color: "#3498db" },
    "track_35": { title: "NEW EDITION - COOL IT NOW (OFFICIAL MUSIC VIDEO)", ytId: "RZUq6N7Gx1c", color: "#f1c40f" },
    "track_36": { title: "CAMEO - WORD UP (RELAID AUDIO) (OFFICIAL MUSIC VIDEO)", ytId: "MZjAantupsA", color: "#2ecc71" },
    "track_37": { title: "MTUME - JUICY FRUIT", ytId: "EYE5QEBOMA8", color: "#9b59b6" },
    "track_38": { title: "ALL I DO", ytId: "-bnx_Qwy7w4", color: "#1abc9c" },
    "track_39": { title: "AND THE BEAT GOES ON", ytId: "ZbxEyWGvWO4", color: "#e67e22" },
    "track_40": { title: "FRANKIE SMITH - DOUBLE DUTCH BUS (OFFICIAL MUSIC VIDEO)", ytId: "fK9hK82r-AM", color: "#34495e" },
    "track_41": { title: "MICHAEL JACKSON - WANNA BE STARTIN' SOMETHIN' (OFFICIAL LYRIC VIDEO)", ytId: "DsJlttdkybk", color: "#e74c3c" },
    "track_42": { title: "MORE BOUNCE TO THE OUNCE", ytId: "ry73m8lNnPA", color: "#3498db" },
    "track_43": { title: "EVERY LITTLE STEP", ytId: "muDCggSpqpE", color: "#f1c40f" },
    "track_44": { title: "EVELYN \"CHAMPAGNE\" KING - LOVE COME DOWN", ytId: "ASiqxSwHpQ8", color: "#2ecc71" },
    "track_45": { title: "SHALAMAR - \"A NIGHT TO REMEMBER\"", ytId: "Qwvf2ilsogo", color: "#9b59b6" },
    "track_46": { title: "TOM BROWNE - FUNKIN' FOR JAMAICA", ytId: "XYclWyC4qQo", color: "#1abc9c" },
    "track_47": { title: "RENE & ANGELA - I'LL BE GOOD", ytId: "VVj1m8uy5AM", color: "#e67e22" },
    "track_48": { title: "WHITNEY HOUSTON - SO EMOTIONAL", ytId: "0YjSHbA6HQQ", color: "#34495e" },
    "track_49": { title: "ATOMIC DOG", ytId: "YAaVpVUgGfE", color: "#e74c3c" },
    "track_50": { title: "THAT GIRL", ytId: "O63F7hkiHiI", color: "#3498db" },
    "track_51": { title: "TEENA MARIE - LOVERGIRL", ytId: "1fyWgjhe_Zg", color: "#f1c40f" },
    "track_52": { title: "EVELYN \"CHAMPAGNE\" KING - I'M IN LOVE", ytId: "p9f_4F-GZgY", color: "#2ecc71" },
    "track_53": { title: "MARY JANE GIRLS - IN MY HOUSE (OFFICIAL HD VIDEO)", ytId: "UF2iuZctLNs", color: "#9b59b6" },
    "track_54": { title: "JANET JACKSON - NASTY", ytId: "ujnq2v6R02U", color: "#1abc9c" },
    "track_55": { title: "DAZZ BAND - LET IT WHIP", ytId: "NOiqT3G2-Go", color: "#e67e22" },
    "track_56": { title: "JANET JACKSON - WHEN I THINK OF YOU", ytId: "EaleKN9GQ54", color: "#34495e" },
    "track_57": { title: "READY FOR THE WORLD - OH SHEILA (OFFICIAL MUSIC VIDEO)", ytId: "wbL2lMn34Oo", color: "#e74c3c" },
    "track_58": { title: "LISA LISA & CULT JAM - HEAD TO TOE", ytId: "51Iq8JmmfxY", color: "#3498db" },
    "track_59": { title: "GOT TO BE REAL (SINGLE VERSION)", ytId: "GLUCCewe_4c", color: "#f1c40f" },
    "track_60": { title: "PRINCE - CONTROVERSY", ytId: "4gazNwzC4H0", color: "#2ecc71" },
    "track_61": { title: "I DIDN'T MEAN TO TURN YOU ON", ytId: "f1i_RJOCXVA", color: "#9b59b6" },
    "track_62": { title: "DO I DO", ytId: "QGNR-gv0sRI", color: "#1abc9c" },
    "track_63": { title: "GUY - GROOVE ME", ytId: "PAu2bsV9CiQ", color: "#e67e22" },
    "track_64": { title: "JODY WATLEY - LOOKING FOR A NEW LOVE", ytId: "YQL-B3PNkeI", color: "#34495e" },
    "track_65": { title: "PEBBLES - GIRLFRIEND", ytId: "Avtj8tdpr5Y", color: "#e74c3c" },
    "track_66": { title: "THE WHISPERS - \"IT'S A LOVE THING\"", ytId: "fJULtwL5zfY", color: "#3498db" },
    "track_67": { title: "RHYTHM OF THE NIGHT", ytId: "eFs8FeXXW-k", color: "#f1c40f" },
    "track_68": { title: "KLYMAXX - MEETING IN THE LADIES ROOM", ytId: "_odTlZaoLCA", color: "#2ecc71" },
    "track_69": { title: "THE PLEASURE PRINCIPLE", ytId: "jXInTVW5h4Y", color: "#9b59b6" },
    "track_70": { title: "GIVE ME THE NIGHT (SINGLE VERSION) [2015 REMASTER]", ytId: "hGszoS9txzg", color: "#1abc9c" },
    "track_71": { title: "CALL ME", ytId: "NDurEK12tQs", color: "#e67e22" },
    "track_72": { title: "JUST GOT PAID", ytId: "LyaXUxMUcrw", color: "#34495e" },
    "track_73": { title: "AIN'T NOTHIN' GOIN' ON BUT THE RENT", ytId: "2cbWVXmLlfg", color: "#e74c3c" },
    "track_74": { title: "ALL NIGHT LONG", ytId: "NGSA_xsCaY8", color: "#3498db" },
    "track_75": { title: "JEFFREY OSBORNE - STAY WITH ME TONIGHT", ytId: "wCWYZHYIPyE", color: "#f1c40f" },
    "track_76": { title: "CONTROL", ytId: "FMuoowyCkUU", color: "#2ecc71" },
    "track_77": { title: "FANTASTIC VOYAGE (EXTENDED)", ytId: "ZeESYzBWl2Q", color: "#9b59b6" },
    "track_78": { title: "ROCK STEADY", ytId: "Os0_Bo51zkE", color: "#1abc9c" },
    "track_79": { title: "MERCEDES BOY", ytId: "oEqGStOxMYg", color: "#e67e22" },
    "track_80": { title: "THE TIME - JUNGLE LOVE (OFFICIAL VINYL VIDEO)", ytId: "7M4fnBoGf5g", color: "#34495e" },
    "track_81": { title: "ARETHA FRANKLIN - JUMP TO IT", ytId: "tD5po4UGGaU", color: "#e74c3c" },
    "track_82": { title: "MIDAS TOUCH", ytId: "qiEg6MuVGZk", color: "#3498db" },
    "track_83": { title: "THE GLAMOROUS LIFE (CLUB EDIT)", ytId: "laUKFzTQQ38", color: "#f1c40f" },
    "track_84": { title: "OBJECT OF MY DESIRE", ytId: "HGaCGJIgTuc", color: "#2ecc71" },
    "track_85": { title: "I LOVE YOU MORE (REMASTERED)", ytId: "6j7smkc8UUY", color: "#9b59b6" },
    "track_86": { title: "I WANT TO THANK YOU", ytId: "us1s-EZSAOU", color: "#1abc9c" },
    "track_87": { title: "1999 (2019 REMASTER)", ytId: "r8bAdallIRY", color: "#e67e22" },
    "track_88": { title: "NO PARKING (ON THE DANCE FLOOR)", ytId: "n5zMwrwRBBE", color: "#34495e" }
  }
};

// Initial tracks list (Hindi)
const cassetteTracks = {
  ...
  "track_62": { title: "MERI DUNIYA HAI SONG WITH EK VILLAIN", ytId: "wI-xNuJcr0M", color: "#1abc9c" },
  "track_63": { title: "TUMHEIN APNA BANANE KI KASAM", ytId: "pqFU_ZX5qfo", color: "#e67e22" },
  "custom_stream": { title: "CUSTOM CASSETTE", ytId: "", color: "#2c3e50" }
};;
...
function alignCompartmentElements() {
  ...
  if (!state.windowCoords) {
    ...
    for (let i = 0; i < data.length; i += 4) {
      ...
      const greenness = g - maxOther;      // Find full extent of green window frame bounding box using low threshold of 12
      if (greenness > 12) {
      ...
      // Perform actual keying out of window green background.
      // Protects radio antenna region (x: 950-1150, y: 300-550) with high threshold of 35, otherwise use 12 for live seat shadows/reflections
      const pixelIndex = i / 4;
      const x = pixelIndex % 1920;
      const y = Math.floor(pixelIndex / 1920);
      const threshold = (x >= 950 && x <= 1150 && y >= 300 && y <= 550) ? 35 : 12;

      if (greenness > threshold) {
        const factor = Math.min(1.0, (greenness - threshold) / 15);
        data[i+3] = Math.round(255 * (1.0 - factor));
        data[i+1] = Math.round(g * (1.0 - factor) + maxOther * factor);
      }
    }
    ...
    // Coords are cached, simply apply safe chroma-keying
    const imgData = ctx.getImageData(0, 0, 1920, 1080);
    const data = imgData.data;
    for (let i = 0; i < data.length; i += 4) {
      const r = data[i];
  ...
  if (offsetY < 0) {
    // Shift crop bias toward the bottom to protect top elements like the fan on wide screens
    offsetY = offsetY * 0.15;
  }

  // Align the canvas element to match the JS cover layout coordinates!
  ...
  const mapElement = (elId, xPct, yPct, wPct, hPct, isSquare = false, clampToScreen = false) => {
    ...
    if (clampToScreen) {
      // Keep inside visible screen bounds with 12px margin
  ...
  // Align window viewport (does not clamp so it fits cutout pixel-perfectly)
  if (state.windowCoords) {
    mapElement('windowViewport', state.windowCoords.x, state.windowCoords.y, state.windowCoords.w, state.windowCoords.h);
  }

  mapElement('fanBlades', 0.545, -0.015, 0.11, 0.11, true); // Cabin fan directly above window
  mapElement('emergencyChain', 0.375, 0.0, 0.05, 0.30); // Chain on left of window
  mapElement('vintagePoster', 0.86, 0.12, 0.11, 0.25, false, true); 
  if (dispHeight < 540) {
    mapElement('switchboardPanel', 0.035, 0.05, 0.17, 0.25, false, true);
    mapElement('clampedTicket', 0.04, 0.68, 0.15, 0.20, false, true);
  } else {
    mapElement('switchboardPanel', 0.035, 0.08, 0.095, 0.35, false, true);
    mapElement('clampedTicket', 0.04, 0.62, 0.20, 0.29, false, true); 
  }
  mapElement('skyClock', 0.04, 0.035, 0.09, 0.04, false, true);
  mapElement('skyOnlineCounter', 0.86, 0.035, 0.10, 0.04, false, true);
  mapElement('chaiGlass', 0.682, 0.61, 0.07, 0.20); // Tea cup on table
  mapElement('bplTapeDeck', 0.52, 0.50, 0.21, 0.33);  
  // Auto-height for the Coach Plaque to avoid clipping soundboard buttons on smaller screen sizes
...
// Chroma-Key Canvas extraction for hand-painted cabin
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const themeExplorerTrigger = document.getElementById('themeExplorerTrigger');
  const themeExplorerClose = document.getElementById('themeExplorerClose');
  if (themeExplorer && themeExplorerTrigger) {
    themeExplorerTrigger.addEventListener('click', (e) => {
      e.stopPropagation();
      themeExplorer.classList.toggle('open');
    });
    if (themeExplorerClose) {
      themeExplorerClose.addEventListener('click', (e) => {
        e.stopPropagation();
  ...
  const btnPlaylistSelect = document.getElementById('btnPlaylistSelect');
...
function setupInteractiveToggles() {
  ...
  if (routeSelector) {
    ...
    routeBtns.forEach(btn => {
      btn.addEventListener('click', (e) => {
        const selectedRouteBtn = e.target.closest('.route-btn');
        if (!selectedRouteBtn) return;
        
        audio.playSwitchClick();
        
        const route = selectedRouteBtn.getAttribute('data-route');
        state.activeRoute = route;
        
        // Update URL path dynamically without reloading the page
        const newPath = route === 'hindi' ? '/' : `/${route}`;
        history.pushState(null, '', newPath);

        // Update button states
        routeBtns.forEach(b => b.classList.toggle('active', b === selectedRouteBtn));
        
        // Toggle body classes for route scenery
        document.body.classList.remove('route-hindi', 'route-punjab', 'route-jammu', 'route-english');
        document.body.classList.add(`route-${route}`);
        
        // Reset window coordinates mapping to force scanning the new illustration's green screen cutout
        state.windowCoords = null;
        
        // Trigger background image reload
        processCabinChromaKey();

        // Swap cassetteTracks tracklist content with the new route
        const newTracks = routePlaylists[route];
        if (newTracks) {
          // Clear current keys
          Object.keys(cassetteTracks).forEach(k => delete cassetteTracks[k]);
          // Load new tracks
          ...
          // Reset active cassette to first track of the new playlist
          state.activeCassette = 'track_1';
          ...
          // Load first cassette automatically
          loadCassette('track_1', cassetteTracks['track_1'].ytId);
        }
      });
    });
  }
...
function setupSoundboardTriggers() {
  ...
  document.getElementById('btnMuteAmbience').addEventListener('click', () => {
  ...
  document.getElementById('btnChai').addEventListener('click', callChaiWallahVoice);
  document.getElementById('btnAnnounce').addEventListener('click', playIndianRailwayAnnouncements);
...
(function() {
  ...
  // Always show splash — user picks their vibe every session
