...
NEW_SPLASH_CSS = """.theme-splash-overlay {
  ...
  /* Rich, luminous twilight sky gradient (cozy night train vibes) */
  background:
    radial-gradient(ellipse 65% 55% at 20% 30%, rgba(255, 170, 70, 0.18) 0%, transparent 60%),
    radial-gradient(ellipse 60% 60% at 80% 80%, rgba(130, 80, 255, 0.15) 0%, transparent 60%),
    radial-gradient(circle at 50% 50%, rgba(255, 255, 255, 0.05) 0%, transparent 50%),
    linear-gradient(135deg, #1b1635 0%, #101224 45%, #0a111a 75%, #050810 100%);
...
.theme-splash-overlay::after {
  ...
  position: fixed;
  inset: 0;
  background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.95' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)' opacity='0.035'/%3E%3C/svg%3E");
...
.splash-orb-gold {
  ...
  background: radial-gradient(circle, rgba(255,160,40,0.18) 0%, rgba(255,100,20,0.06) 45%, transparent 70%);
  animation-delay: 0s;
}
.splash-orb-purple {
  width: 520px; height: 520px;
  bottom: -120px; right: -80px;
  background: radial-gradient(circle, rgba(140,70,255,0.15) 0%, rgba(80,20,180,0.04) 50%, transparent 70%);
  animation-delay: -4s;
}
.splash-orb-green {
  width: 450px; height: 450px;
  bottom: 20%; left: 25%;
  background: radial-gradient(circle, rgba(40,210,120,0.12) 0%, rgba(20,130,60,0.03) 50%, transparent 70%);
  animation-delay: -8s;
}
@keyframes orbDrift {
...
.theme-splash-logo {
  ...
  filter: drop-shadow(0 0 35px rgba(255, 180, 60, 0.7))
          drop-shadow(0 0 10px rgba(255, 120, 20, 0.45));
  line-height: 1;
}
...
.theme-splash-title {
  ...
  background: linear-gradient(135deg, #ffffff 40%, #ffdfa9 100%) !important;
...
print("Twilight Cozy Splash CSS applied successfully!")
