...
print(f"Running yt-dlp to dump playlist JSON for: {url}...")
...
try:
    ...
    print(f"yt-dlp successfully retrieved {len(entries)} tracks!")
    ...
    print(f"Successfully wrote {len(entries)} tracks to jammu_tracks.txt!")
